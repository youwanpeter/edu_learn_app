...
final success = await viewModel.updateCourse(updatedCourse, widget.user);
if (success) {
...
final success = await viewModel.addCourse(newCourse, widget.user);
if (success) {
ScaffoldMessenger.of(context).showSnackBar(
const SnackBar(
...
try {
final viewModel = context.read<CourseViewModel>();
final success = await viewModel.deleteCourse(widget.course!.id, widget.user);
